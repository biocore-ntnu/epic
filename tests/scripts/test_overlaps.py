...
from epic.scripts.overlaps.overlaps import (_compute_nucleotide_overlap,
                                    _compute_region_overlap,
                                    _create_overlap_matrix_regions,
                                    _create_overlap_matrix_nucleotides)
...
# commenting out these because the function needs to be nested in another for parallelism
